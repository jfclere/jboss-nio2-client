...
do
  ...
  # concat the result files
  # 1000 $i 1000000 5000
  rm ~/1000-$i-1000000-5000-log.txt
  for file in `ls ~/1000-$i-1000000-5000-box.*`
  do
    cat $file >>  ~/1000-$i-1000000-5000-log.txt
  done
